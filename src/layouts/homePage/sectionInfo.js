    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                ТОВ &qout;ДІДЖИ ФІНАНС&qout; заснована в 2018р. провідними експертами ринку управління проблемних активів.
                ...
                ТОВ &qout;ДІДЖИ ФІНАНС&qout; – одна з ключових компаній на ринку, що здійснює систематичні купівлі та обслуговування портфелів NPL, що мають забезпечення (іпотеки, застави, транспортні засоби, спец обладнання, тощо), а також кредити без забезпечень
                </CustomDesc>
