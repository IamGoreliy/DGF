...
export const DescriptionServiceSectiom = () => {
  return (
    ...
    >
      ...
      <CustSpan>
        ТОВ &quot;ДІДЖИ ФІНАНС&qout; заснована в 2018 р. провідними експертами ринку управління проблемних активів.
      ...
      <CustSpan>
        ТОВ &qout;ДІДЖИ ФІНАНС&qout; – одна з ключових компаній на ринку, що здійснює систематичні купівлі та обслуговування
